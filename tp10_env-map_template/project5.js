	...
	for (var f=0; f<param.files.length; f++)
	{
		...
		switch (param.files[f].name.split('.')[0])
		{
			case "x":
				...
				{
					imageX.onload = function() { meshDrawer.setEnvMap( imageX, gl.TEXTURE_CUBE_MAP_POSITIVE_X ); }
			...
			case "x_":
				...
				{
					imageX_.onload = function() { meshDrawer.setEnvMap( imageX_, gl.TEXTURE_CUBE_MAP_NEGATIVE_X ); }
			...
			case "y":
				...
				{
					imageY.onload = function() { meshDrawer.setEnvMap( imageY, gl.TEXTURE_CUBE_MAP_POSITIVE_Y ); }
			...
			case "y_":
				...
				{
					imageY_.onload = function() { meshDrawer.setEnvMap( imageY_, gl.TEXTURE_CUBE_MAP_NEGATIVE_Y ); }
			...
			case "z":
				...
				{
					imageZ.onload = function() { meshDrawer.setEnvMap( imageZ, gl.TEXTURE_CUBE_MAP_POSITIVE_Z ); }
			...
			case "z_":
				...
				{
					imageZ_.onload = function() { meshDrawer.setEnvMap( imageZ_, gl.TEXTURE_CUBE_MAP_NEGATIVE_Z ); }
